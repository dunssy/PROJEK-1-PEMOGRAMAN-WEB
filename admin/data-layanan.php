                    ...
                    <!-- Header halaman -->
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            ...
                            <a 
                                ...
                                class="inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-bold text-white bg-[#C75C7A] rounded-xl hover:bg-[#B14F6C] shadow-sm shadow-[#FAD7E5] transition-colors w-fit"
                            >
                            ...
                            <table class="w-full text-left border-collapse min-w-[700px]">
                                ...
                                <thead>
                                    <tr class="bg-[#EFA9BF] border-b border-[#EFA9BF] text-white font-semibold">
                                        ...
                                        <th class="p-4">Harga Minimal</th>
                                        <th class="p-4">Harga Maksimal</th>
                                    ...
                                    <?php if (!empty($layanan)){ ?>
                                        ...
                                        <?php foreach ($layanan as $data_layanan  ){ ?>
                                            ...
                                            <tr class="hover:bg-[#FDEAF1]/60 transition-colors">
                                                ...
                                                <!-- Harga layanan -->
                                                <td class="p-4">
                                                    Rp <?= number_format($data_layanan['harga_max'], 0, ',', '.'); ?>
                                                </td>
                                                ...
                                                <td class="p-4 text-center">
                                                    <div class="flex items-center justify-center gap-2">
                                                        ...
                                                        <!-- Tombol detail -->
                                                        <a 
                                                            href="detail-layanan.php?id_layanan=<?= $data_layanan['id_layanan']; ?>" 
                                                            class="inline-flex items-center justify-center w-8 h-8 bg-green-50 text-green-500 rounded-lg hover:bg-green-100 transition"
                                                            title="Detail"
                                                        >
